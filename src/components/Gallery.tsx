...
const Gallery = () => {
  ...
  const images = [
    ...
    { id: 12, cat: "resultados", title: "Lentes & Estética", sub: "Caso Clínico Real" },
    { id: 16, cat: "clinica", title: "Nossa Estrutura", sub: "Ambiente Premium" },
    { id: 2, cat: "clinica", title: "Protocolo 360", sub: "Tecnologia & Cuidado" },
    { id: 5, cat: "clinica", title: "Facetas em Resina", sub: "Estética Orofacial" },
    { id: 10, cat: "clinica", title: "Campanhas BCLINIC", sub: "Março Delas" },
    { id: 14, cat: "clinica", title: "Clareamento", sub: "Tratamento Premium" },
